package com.example.panzq.mywifiapplication.wifi;
...
public class LinkWifi {
    ...
    public boolean ConnectToNetID(int netID) {
        Log.d("panzqww","ConnectToNetID ------ netID ==== " + netID);
    ...
    public int CreateWifiInfo2(ScanResult wifiinfo, String pwd) {
        ...
        Log.d("panzqww","CreateWifiInfo2 ---- wifiinfo.capabilities === "+wifiinfo.capabilities);
